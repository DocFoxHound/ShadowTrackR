...
#  <2025-04-13T17:17:51.279Z> [Notice] <Actor Death> CActor::Kill: 'Mercuriuss' [200146297631] in zone 'ANVL_Hornet_F7A_Mk2_2677329226210' killed by 'DocHound' [202061381370] using 'GATS_BallisticGatling_S3_2677329225797' [Class unknown] with damage type 'VehicleDestruction' from direction x: 0.000000, y: 0.000000, z: 0.000000 [Team_ActorTech][Actor]
    ...
    try:
        ...
        if response.status_code == 200 or response.status_code == 201:
            ...
            logger.log("Relaunch ShadowTrackr and reconnect with a new Key.")
...
def setup_gui(game_running):
    ...
    # Set the icon
    try:
        icon_path = resource_path("assets/programicon.ico")
    ...
    # Add Banner
    try:
        banner_path = resource_path("assets/ShadowTrackR.png")
    ...
    if game_running:
        ...
        message_label = tk.Label(
            app,
            text="You must launch Star Citizen before starting the tracker.\n\nPlease close this window, launch Star Citizen, and relaunch ShadowTrackR. ",
    ...
    footer_text = tk.Label(
        footer,
        text="Stolen by BlightVeil, then rebranded by ShadowMoses' IronPoint Team",
